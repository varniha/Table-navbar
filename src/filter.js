...
function Filter(props) {
  ...
  const { onStaff, onDept, onDesig, onLatecomer, onDayWise, onDateRange } =
    onChange;
          ...
          <div className="row-1">
            ...
            <div className="inputgrp">
              ...
              <input
                type="text"
                value={desig}
                onChange={(e) => onDesig(e.target.value)}
                list="desig"
              ></input>
              <datalist id="desig">
            ...
            <div className="late">
              <label htmlFor="latecomer">
                <input
                  value={latecomer}
                  onChange={(e) => onLatecomer(e.target.checked)}
                  type="checkbox"
                  id="latecomer"
                ></input>
                Latecomer
            ...
            <div className="date">
              <div>
                <label>
                  <input
                    type="checkbox"
                    value={dayWise.checked}
                    onChange={(e) =>
                      onDayWise({ ...dayWise, checked: e.target.checked })
                    }
                  ></input>
                  Daywise
                </label>
              ...
              <div>
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      onDateRange({ ...dateRange, checked: e.target.checked })
                    }
                  ></input>
                  Range of dates
                </label>
